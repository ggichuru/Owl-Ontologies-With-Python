...
onto = get_ontology("BlightTestOnto/blimy_o1.owl").load()
...
def page_result():
    ...
    with onto_tmp:
        ...
        if temp == "True": blightPeriod.isBlightTemp = True
        elif temp == "False": blightPeriod.isBlightTemp = False

        if humd == "True": blightPeriod.isBlightHumd = True
        elif humd == "False": blightPeriod.isBlightHumd = False
